...
// Auth
import { AuthNoticeService, AuthService } from '@module/auth';
...
export class ForgotPasswordComponent implements OnInit, OnDestroy {
    ...
    .subscribe(
      ...
      error => {
        console.error(error);
        this.loading = false;
        if (error.error.InternalCode === 2) {
          this.authNoticeService.setNotice('This email address is not associated to any account.', 'danger');
        } else {
