...
environment.environment = 'Sandbox RS';
...
environment.secUrl = 'https://sandboxapi.relationshop.net/v6/sec/api';
environment.unitedUrl = 'https://sandboxapi.relationshop.net/v6/dxp/api';
environment.relationShopUrl = 'https://sandboxapi.relationshop.net/v6/dxp/api';
environment.centralUrl = 'https://sandboxapi.relationshop.net/v6/central/api';
...
environment.offerUrl = 'https://sandboxapi.relationshop.net/v6/offer/api';
...
environment.unitedTempUrl = 'https://sandboxapi.relationshop.net/v6/dxp/api';

environment.distributionUrl = 'https://sandboxapi.relationshop.net/V6/Distribution/api';
